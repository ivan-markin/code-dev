...
<body>
  <amp-story standalone>
    <amp-sidebar id="sidebar1" layout="nodisplay" style="background-color: rgba(0, 0, 0, .9);">
      <div style="display: flex; align-items: center; justify-content: center; height: 100vh; position: relative;">
        <a on="tap:sidebar1.close" style="position: absolute; right: 20px; top: 20px; z-index: 100; cursor: pointer;">
          <svg width="31" height="31" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
            <line x1="1.85791" y1="28.7284" x2="28.728" y2="1.85831" stroke="white" stroke-width="2" stroke-linecap="round" />
            <line x1="1" y1="-1" x2="39" y2="-1" transform="matrix(-0.707107 -0.707107 -0.707107 0.707107 29.1422 30.1426)" stroke="white" stroke-width="2" stroke-linecap="round" />
          </svg>
        </a>
        <amp-img src="./assets/blueprint-4.png" width="191" height="431" layout="responsive" alt="" style="width: 80%;">
        </amp-img>
      </div>
    </amp-sidebar>
    ...
    <amp-story-page id="page2" auto-advance-after="10s">
      ...
      <amp-story-grid-layer template="vertical" style="padding: 30px 20px 0;">
        ...
        <p style="font-size: 11px;" animate-in="fly-in-left" animate-in-duration="1s" animate-in-delay="0.8s">Уникальная атмосфера продумана до&nbsp;мельчайших деталей:</p>
        <ul style="margin-left: 6px; padding: 0; list-style: '- '; font-size: 11px;">
          ...
          <li animate-in="fly-in-left" animate-in-duration="1s" animate-in-delay="1.3s">тактильно приятные материалы</li>
        </ul>
      </amp-story-grid-layer>
      <amp-story-grid-layer template="vertical" style="padding: 0 20px;">
    ...
    <amp-story-page id="page3" auto-advance-after="10s">
      ...
      <amp-story-grid-layer template="vertical" style="padding: 30px 20px 0;">
        ...
        <ul style="margin-left: 6px; padding: 0; list-style: '- '; font-size: 11px; line-height: 1.56;">
          ...
          <li animate-in="fly-in-left" animate-in-duration="1s" animate-in-delay="0.7s">интеграция в&nbsp;городские сообщества</li>
          <li animate-in="fly-in-left" animate-in-duration="1s" animate-in-delay="0.8s">транспортные и&nbsp;курьерские услуги</li>
          <li animate-in="fly-in-left" animate-in-duration="1s" animate-in-delay="0.9s">бронирование билетов, столиков</li>
          <li animate-in="fly-in-left" animate-in-duration="1s" animate-in-delay="1s">организация праздников</li>
          <li animate-in="fly-in-left" animate-in-duration="1s" animate-in-delay="1.1s">помощь в&nbsp;решении разных вопросов</li>
        </ul>
      </amp-story-grid-layer>
      <amp-story-grid-layer template="vertical" style="padding: 0 20px;">
        ...
        <div class="extended-parameters-block">
          <div style="display: flex; flex-direction: column; justify-content: space-between; width: 50%;">
            <ul style="margin: 0 0 15px 0; padding: 0; list-style: none; font-size: 9px; font-weight: 600;">
              <li animate-in="fly-in-left" animate-in-duration="1s" animate-in-delay="0.6s">Отделка и мебель</li>
              ...
              <li animate-in="fly-in-left" animate-in-duration="1s" animate-in-delay="1.2s">NFC доступ 24/7</li>
              <li animate-in="fly-in-left" animate-in-duration="1s" animate-in-delay="1.3s">Консьерж-сервис</li>
            </ul>
            <div>
          ...
          <div class="blueprint-block" animate-in="fly-in-right" animate-in-duration="1s" animate-in-delay="0.6s" style="position: relative;">
            <a animate-in="fade-in" animate-in-duration="1.2s" animate-in-delay="1s" on="tap:sidebar1" role="button" style="display: flex; align-items: center; justify-content: center; position: absolute; top: calc(50% - 30px); left: calc(50% - 30px); width: 60px; height: 60px; background-color: white; color: black; font-size: 48px; border-radius: 50%; z-index: 10000">
    ...
    <amp-story-page id="page5" auto-advance-after="10s">
      ...
      <amp-story-grid-layer template="vertical" style="padding: 30px 20px 0;">
        ...
        <div class="extended-parameters-block">
          <div style="display: flex; flex-direction: column; justify-content: space-between; width: 50%;">
            <ul style="margin: 0 0 15px 0; padding: 0; list-style: none; font-size: 9px; font-weight: 600;">
              <li animate-in="fly-in-left" animate-in-duration="1s" animate-in-delay="0.6s">Индивидуальная планировка</li>
              <li animate-in="fly-in-left" animate-in-duration="1s" animate-in-delay="0.7s">Отделка и мебель</li>
              <li animate-in="fly-in-left" animate-in-duration="1s" animate-in-delay="0.8s">Эксплуатация инж. систем</li>
              ...
              <li animate-in="fly-in-left" animate-in-duration="1s" animate-in-delay="1.1s">Расходники в общие зоны</li>
              <li animate-in="fly-in-left" animate-in-duration="1s" animate-in-delay="1.2s">NFC доступ 24/7</li>
              <li animate-in="fly-in-left" animate-in-duration="1s" animate-in-delay="1.3s">Консьерж-сервис</li>
            </ul>
            <div>
